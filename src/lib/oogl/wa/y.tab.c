...
#line 129 "../../../../../src/lib/oogl/wa/fsaparse.y"
    {
		      fsa->genlist[(yyvsp[(1) - (3)].i)-1] =
			(char*)malloc((strlen((yyvsp[(3) - (3)].s))+1)*sizeof(char));
		      strcpy(fsa->genlist[(yyvsp[(1) - (3)].i)-1], (yyvsp[(3) - (3)].s));
		    }
    break;
...
#line 157 "../../../../../src/lib/oogl/wa/fsaparse.y"
    { install_adjacency((yyvsp[(1) - (4)].i)); adj_index = 0; }
    break;
